...
while($row = mysqli_fetch_array($result))
{
		...
		echo $qnum, ". ", html_entity_decode($question), "<br>", "<br>";

		echo "<input type=radio name='num$qnum' value='$val1'>" , html_entity_decode($answer1), "<br>";
		echo "<input type=radio name='num$qnum' value='$val2'>" , html_entity_decode($answer2), "<br>";
